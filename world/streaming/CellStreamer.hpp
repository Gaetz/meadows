...
// Distance-driven cell residency: keeps the cells around
...
// by design: async streaming + per-cell persistence is a separate,
// later concern; do not anticipate it here.
//
...
public:
    ...
    // only on change.
    //
    // `maxLoads` (smoothed streaming v1): 0 = load the
    ...
    // Editor "load this cell NOW": loads `cell`
