...
// .trg file: magic "TRG1", u32 width, u32 height, f32 originX, f32 originZ,
...
// then the five u8 channels (detailAmp, flow, wetness, beach, biome) of
// maskWidth*maskHeight each. Little-endian.
