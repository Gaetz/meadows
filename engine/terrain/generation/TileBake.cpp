...
TileBakeResult bakeTileStage2(
    ...
    // (Option D's per-tile steady-water solve lived here: fields
    // written by no caller since the option-C pivot — purged E5. The
    // .trg water header ships dims 0; the reader stays tolerant.)
