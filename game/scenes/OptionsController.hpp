...
// The OPTIONS screen: look settings, master volume and
...
struct OptionsContext {
    ...
    const data::TextTable& texts; // On/Off + action labels
    // The scene's LIVE language application — rebuild the TextTable
...
// The audio facade has no engine-level master knob — its contract is
...
public:
    ...
    // and the pad->UI routing on this, so the captured press (B,
