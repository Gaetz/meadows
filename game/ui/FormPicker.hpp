...
// (e.g. an anim state's `clip`). Sees exactly
...
// ITEM guid fields (dialogue takeItem, quest rewardItem, condition
...
// Guid fields that point at ONE known Form type (a state's clip,
