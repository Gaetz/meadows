...
| **Chantier GI — Radiance Cascades 3D** (GI dynamique world-space, technique SWITCHABLE en parallèle du lighting actuel, qualité d'abord puis descente perf par le dev via knobs UI) | 🔨 **EN COURS 2026-07-11** — plan : `docs/RADIANCE-CASCADES.md` ; G0 (RHI textures 3D) ✅ `9f7d535`, G1 (doc) ✅ ; suivent G2 clipmap voxel → G6 apply switchable (non committé avant validation visuelle) |
