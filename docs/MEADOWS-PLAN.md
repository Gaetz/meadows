...
| **Chantier 7 — Graphisme restant** (shafts à poussière 34, contact shadows + terrain shadows + skylighting 33, eau plaçable 32, ombre de lumière clé B2b, cumulonimbus 30, pluie+wetness 31, herbe ⏸️) | ⬅️ **PROCHAIN** — plan : `docs/CHANTIER-7.md` ; specs : `docs/3D-RENDERER.md`. L'axe B du chantier 6 est **validé et commité par le dev (2026-07-07)**. Chantiers suivants esquissés dans CHANTIER-7 : 8 outillage, 9 confort & plateforme, 10 son & vie (ordre dev 2026-07-07) |
| Refonte herbe (renderer) | ⏸️ en attente des recherches du dev (brique 7.8) |
