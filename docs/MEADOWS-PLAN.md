...
| **Chantier 7 — Graphisme restant** (shafts à poussière 34, contact shadows 33a, terrain shadows + skylighting 33b/c, eau plaçable 32, ombre de lumière clé B2b, cumulonimbus 30, pluie+wetness+occlusion 31) | ✅ FAIT 2026-07-07 (**validation visuelle dev en attente**) — journal : `docs/CHANTIER-7.md` ; specs : `docs/3D-RENDERER.md`. Reste : **7.8 herbe** (réf. dev reçue : daniel-ilett/shaders-botw-grass — à faire en session dédiée). Chantiers suivants : 8 outillage, 9 confort & plateforme, 10 son & vie (ordre dev 2026-07-07) |
