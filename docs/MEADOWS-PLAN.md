...
| **Chantier 8 — Outillage** (GameDB duplication+used-by, éditeur de quêtes, éditeur de dialogues, timeline des schedules, outil de synthesis patch §5.1) | 🔨 EN COURS 2026-07-07 — plan : `docs/CHANTIER-8.md`. Éditeurs anim/FX/UI restent P1 hors chantier (P0 = TOML + hot-reload) |
