...
| **Chantier 8 — Outillage** (GameDB duplication+used-by, éditeur de quêtes, éditeur de dialogues, timeline des schedules, outil de synthesis patch §5.1) | ✅ FAIT 2026-07-07, 5/5 briques (**validation manuelle dev en attente**) — journal : `docs/CHANTIER-8.md`. FieldConflict porte désormais les VALEURS des écrivains ; la sortie de chaque outil = plugin ordinaire (§5). Éditeurs anim/FX/UI restés P1 hors chantier (P0 = TOML + hot-reload). Suivants : 9 confort & plateforme, 10 son & vie |
